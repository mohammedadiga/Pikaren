...
<script src="{{url('assets/js/custom/account/security/license-usage.js')}}"></script>
<!--end::Custom Javascript-->

<script src="{{url('assets/js/custom/inputmask.js')}}"></script>
<script>function myFunction() {document.getElementById("vcardForm").submit();}</script>

{{-- <script src="{{url('assets/js/custom/addContact.js')}}"></script> --}}
<!--end::Javascript-->
</body>
</html>